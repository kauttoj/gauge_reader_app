classdef gauge_reader_app < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.dtEditFieldLabel.Position = [10 120 55 22]; 
    ...
    methods (Access = public)
        ...
        % modified by Janne K. to work with RGB images and Euclidean distance.
        ...
        reg_mean = squeeze(I(x,y,:))'; % The mean of the segmented region
        reg_size = 1; % Number of pixels in region

        % Free memory to store neighbours of the (segmented) region
        neg_free = 10000; neg_pos=0;
        neg_list = zeros(neg_free,3+2); 
        ...
        while(pixdist<reg_maxdist&&reg_size<numel(I))
            ...
            for j=1:4,
                ...
                if(ins&&(J(xn,yn)==0)) 
                        neg_pos = neg_pos+1;
                        neg_list(neg_pos,:) = [xn,yn,squeeze(I(xn,yn,:))']; J(xn,yn)=1;
                end
            end
            ...
            dist = (neg_list(1:neg_pos,3:5)-reg_mean).^2;
